package  
{
	...
	The Digital_Clock_Art class makes a "face" for a digital clock with 6 digits.
	...
	'shadow' behind the digits to imply the segment exists, but is not being used.
	
	It's the exact same as the Digital_Clock_Shadow class, but has a background drawn in!
	
	*/
	
	public class Digital_Clock_Art extends Sprite
	{
		//Declared Array to Contain Clock Digits//
		public var clockDigits: Array;
			
		/*
		Summary of the Digital_Clock_Art constructor:
		The Digital_Clock_Shadow constructor describes the "owner" of the object and x/y values of where to place it.
		...
		*/
		...
		public function Digital_Clock_Art(thisStage:DisplayObjectContainer, xScale, yScale, xCoordinate,yCoordinate, dRotation) 
		{
			...
			//Parameter Arguments//
			thisStage.scaleX =xScale;
			thisStage.scaleY =yScale;
			
			thisStage.x = xCoordinate;
			thisStage.y = yCoordinate;
			
			thisStage.rotation = dRotation;
			
			//Declared Variables to Contain Shadow Objects for Every Digit//
			var clockDigitShadow0 = new Shadow(this, 1, 1, -200, 0, 0);
			var clockDigitShadow1 = new Shadow(this, 1, 1, -150, 0, 0);
			var clockDigitShadow2 = new Shadow(this, 1, 1, -80, 0, 0);
			var clockDigitShadow3 = new Shadow(this, 1, 1, -30, 0, 0);
			var clockDigitShadow4 = new Shadow(this, 1, 1, 40, 0, 0);
			var clockDigitShadow5 = new Shadow(this, 1, 1, 90, 0, 0);
			var clockDigitShadow6 = new Shadow(this, 1, 1, 160, 0, 0);
			var clockDigitShadow7 = new Shadow(this, 1, 1, 210, 0, 0);
			var clockDigitShadow8 = new Shadow(this, 1, 1, 260, 0, 0);
